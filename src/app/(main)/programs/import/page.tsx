    ...
    <div className="flex flex-col h-screen bg-background overflow-hidden font-sans">
      ...
      <header className="flex h-16 shrink-0 items-center justify-between gap-2 border-b px-6 bg-background">
        <div className="flex items-center gap-2 px-1">
          ...
          <span className="text-sm font-medium text-muted-foreground">Import Program</span>
        </div>
      </header>
          ...
          <CardContent className="pt-8 pb-8 flex flex-col items-center text-center space-y-6">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground px-4">
                Halaman import program ini tidak lagi digunakan atau tidak berguna. Saat ini sedang dinonaktifkan / dalam pembangunan.
              </p>
            </div>
